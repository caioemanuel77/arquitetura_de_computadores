...
memory.write_byte(1, 26)   # CLEAR
memory.write_byte(2, 24)   # INC
memory.write_byte(3, 24)   # INC
memory.write_byte(4, 24)   # INC
memory.write_byte(5, 6)    # STORE
memory.write_byte(6, 220)
memory.write_byte(7, 255)
"""
memory.write_word(200, 1234)

memory.write_byte(1, 20)    # LOAD
memory.write_byte(2, 200)

memory.write_byte(3, 6)     # STORE
memory.write_byte(4, 220)

memory.write_byte(5, 255)   # HALT
