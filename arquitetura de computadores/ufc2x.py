...
firmware[4] = 0b00000010100000010100000001000000
              #H = MDR; GOTO 5
firmware[5] = 0b00000000000000111100000100000011 # 9 de next + 3 de jam + 8 de alu + 6 de bus_c + 3 de mem + 3 de bus_b             
              #X = H + X; GOTO 0
# STORE
#6: memory[address] = X
...
# LOAD
#20: X = mem[address]
firmware[20] = 0b00001010100000110101001000001001 # 9 de next + 3 de jam + 8 de alu + 6 de bus_c + 3 de mem + 3 de bus_b
               # PC <- PC + 1; FETCH; goto 21

firmware[21] = 0b00001011000000010100100000010010
               # MAR <- MBR; READ_WORD; goto 22
