...
firmware[2] = 0b00000001100000110001010001100000 
              # BUS_C = 1; H = MDR = BUS_C; memory.write_word(0, MDR); Vai para instrṳ̣o 1.
firmware[3] = 0b00000001100000111001010001100000
              # BUS_C = H + 1; H = MDR = BUS_C; memory.write_word(0, MDR); Vai para instrṳ̣o 1.

#PROGRAMA DE CONTAGEM REGRESSIVA 256-0 = CRG
firmware[5] = 0b00000011000011110001010001100000
              # BUS_C = 256; H = MDR = BUS_C; memory.write_word(0, MDR); Vai para instrṳ̣o 1.
firmware[6] = 0b00000011000100110110010001100000
              # BUS_C = MDR - 1; H = MDR = BUS_C; memory.write_word(0, MDR); Vai para instrṳ̣o 1 se ALU != 0 ou instrṳ̣o 262 se ALU == 0.
